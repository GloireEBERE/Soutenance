...
<html lang="en">
    ...
    <body>
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">La liste des tâches déjà accomplies</li>
                    </ol>
                </nav>
            </div>
            <!-- End Page Title -->
            ...
            <div class="container">
                <h2 class="text-center">La liste des tâches déjà accomplies</h2>
            </div>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $taches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tache): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($tache->stagiaire->user->nom ?? 'N/A'); ?></td>
                                    
                                    <td><?php echo e(ucfirst($tache->statut)); ?></td>
                                </tr>
...
</html><?php /**PATH C:\laragon\www\stagiaire\resources\views/tuteur/listeTacheAccomplie.blade.php ENDPATH**/ ?>