...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
        <form class="search-form d-flex align-items-center" method="GET" action="<?php echo e(route('resultat')); ?>">
            <input type="text" name="query" placeholder="Recherche" title="Veuillez écrire un mot">
        ...
        <ul class="d-flex align-items-center">
            <?php if(auth()->check()): ?>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
                        <li class="dropdown-header">
                            Vous avez <?php echo e(auth()->user()->unreadNotifications->count()); ?> notifications
                            <a href="<?php echo e(route('notifications.lues')); ?>">
                        ...
                        <li class="dropdown-footer">
                            <a href="<?php echo e(route('notifications')); ?>">Voir toutes les notifications</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown pe-3">
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="<?php echo e(route('profile')); ?>" data-bs-toggle="dropdown">
...
</header><!-- End Header --><?php /**PATH C:\laragon\www\stagiaire\resources\views/layouts/header.blade.php ENDPATH**/ ?>