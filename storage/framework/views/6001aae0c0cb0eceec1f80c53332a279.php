    ...
    <body>
        ...
        <main id="main" class="main">
            ...
            <div class="table-responsive ">
                <?php if($stagiaire->demandes->isEmpty()): ?>
                            ...
                            <?php $__currentLoopData = $demandes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $demande): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php elseif($demande->statut == 'refusée'): ?>
                                    ...
                                    <td>
                                        <?php if($demande->statut == 'en attente'): ?>
                                            <a href="<?php echo e(route('demande.affiche', $demande->id)); ?>" class="btn btn-sm btn-primary">Modifier</a>
                                            
                                            <form action="<?php echo e(route('demande.delete', $demande->id)); ?>" method="POST" class="d-inline">
                                                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\stagiaire\resources\views/stagiaire/listeDemande.blade.php ENDPATH**/ ?>