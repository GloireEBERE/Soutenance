        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Tâche à faire</li>
                    </ol>
                </nav>
            </div>
            <!-- End Page Title -->
            ...
            <div class="flex items-center justify-center bg-gray-100">
                <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                    <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center">Attribution de tâche</h2>
                    <form action="<?php echo e(route('tacheAttribuer')); ?>" method="POST" class="space-y-4" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <!-- Champ pour le titre -->
                        <div class="mb-4">
...
</html><?php /**PATH C:\laragon\www\stagiaire\resources\views/tuteur/TacheFaire.blade.php ENDPATH**/ ?>