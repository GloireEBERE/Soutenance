    ...
    <body>
        ...
        <header style="display: flex; justify-content: space-between; align-items: center; padding: 1rem; background-color: #f8f9fa;">
            <div style="display: flex; align-items: center;">
                <a href="<?php echo e(route('welcome')); ?>" style="display: flex; align-items: center; text-decoration: none; color: black;">
                    <img src="<?php echo e(asset('assets/admin/img/switch-favicon.png')); ?>" alt="Logo" style="width: 40px; height: 40px; margin-right: 10px;">
            ...
            <nav>
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <?php elseif(auth()->user()->role === 'tuteur'): ?>
                    ...
                    <?php endif; ?>
                <?php else: ?>
                    <a class="btn btn-primary" href="<?php echo e(route('login')); ?>">Se connecter</a>
                    <a class="btn btn-secondary ms-2" href="<?php echo e(route('inscription.form')); ?>">S'inscrire</a>
                <?php endif; ?>
            </nav>
        ...
        <section class="video-container">
            <video autoplay muted loop>
                <source src="<?php echo e(asset('assets/admin/img/Bienvenue.mp4')); ?>" type="video/mp4">
            </video>
            
            <div class="video-overlay">
                <h2>Bienvenue</h2>
                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->role === 'stagiaire'): ?>
                        <div class="action-buttons">
                            <a href="<?php echo e(route('AfficherDemande')); ?>">Soumettre la demande de stage </a>
                            <a href="<?php echo e(route('stagiaire.demandes')); ?>">Mes demandes de stage </a>
                        </div>
                    <?php endif; ?>
        ...
        <section class="about-us">
            ...
            <div style="display: flex; align-items: center; justify-content: center; text-align: left;">
                <img src="<?php echo e(asset('assets/admin/img/programer-switch-maker.jpg')); ?>" alt="Image" style="width: 40%; height: auto; margin-right: 20px;">
        ...
        <section class="newsletter" style="background-color: #f8f9fa; padding: 2rem; text-align: center; margin-top: 2rem;">
            ...
            <form action="<?php echo e(route('newsletter.subscribe')); ?>" method="POST" style="max-width: 600px; margin: 0 auto;">
                <?php echo csrf_field(); ?>
                ...
                <?php if(session('newsletter_success')): ?>
                    <p style="margin-top: 1rem; color: green;"><?php echo e(session('newsletter_success')); ?></p>
                <?php endif; ?>
                
                <?php if(session('newsletter_error')): ?>
                    <p style="margin-top: 1rem; color: red;"><?php echo e(session('newsletter_error')); ?></p>
                <?php endif; ?>
            </form>
        </section>
...
<?php /**PATH C:\laragon\www\stagiaire\resources\views/welcome.blade.php ENDPATH**/ ?>