...
<html lang="en">
    ...
    <body>
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">La liste complète</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
            ...
            <div class="container">
                <h2 class="text-center">La liste des personnes enregistrées</h2>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td><?php echo e($row->user->nom ?? $row->nom); ?></td>

                                <td><?php echo e($row->user->prenom ?? $row->prenom); ?></td>

                                <td><?php echo e($row->user->email ?? $row->email); ?></td>
                                ...
                                <td><?php echo e($row->user->role ?? $row->role); ?></td>
                            </tr>
...
</html><?php /**PATH C:\laragon\www\stagiaire\resources\views/admin/affiche.blade.php ENDPATH**/ ?>