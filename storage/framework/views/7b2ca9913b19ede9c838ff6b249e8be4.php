            ...
            <div class="flex items-center justify-center bg-gray-100">
                <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                    <div class="text-center mb-4">
                        ...
                        <h3 class="mt-3">Bienvenue, <b> <?php echo e(Auth::user()->prenom); ?> <?php echo e(Auth::user()->nom); ?> </b> !</h3>
                        <p class="text-muted">Nous sommes heureux <i class="bi bi-emoji-smile"></i> de vous accueillir sur votre tableau de bord.</p>
                    </div>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\laragon\www\stagiaire\resources\views/tuteur/index.blade.php ENDPATH**/ ?>