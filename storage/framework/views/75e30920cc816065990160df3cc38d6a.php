...
<html lang="en">
    ...
    <body>
        ...
        <main id="main" class="main">
            ...
            <?php if($demandeRecente): ?>
                <?php if($demandeRecente->statut === 'en attente'): ?>
                    <!-- Cas en attente -->
                ...
                <?php elseif($demandeRecente->statut === 'acceptée'): ?>
                    <!-- Cas acceptée -->
                    <div class="text-center">
                        <div class="flex justify-center items-center">
                ...
                <?php elseif($demandeRecente->statut === 'refusée'): ?>
                    <!-- Cas refusée -->
                    <div class="text-center">
                        <div class="flex justify-center items-center">
...
</html><?php /**PATH C:\laragon\www\stagiaire\resources\views/stagiaire/dashboard.blade.php ENDPATH**/ ?>