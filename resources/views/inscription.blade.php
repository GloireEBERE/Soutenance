            ...
            <section class="signup">
                ...
                <div class="container">
                    <div class="signup-content">
                        <form action="{{ route('inscription.submit') }}" method="POST" id="signup-form" class="signup-form" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-12 mb-5">
                                ...
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                        <div id="imagePreview" style="background-image: url('{{ url('/img/logo.png') }}')"></div>
                                    </div>
                                </div>
                        ...
                        <p class="loginhere">
                            Avez-vous déjà un compte ? <a href="{{ route('login') }}" class="loginhere-link">Se connecter</a>
                        </p>
                    </div>
                </div>
            </section>
