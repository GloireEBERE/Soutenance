                        ...
                        <div class="card-body pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview"> 
                                ...
                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                    ...
                                    <form action="{{ route('profil.update') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <img src="{{ $user->photo ? asset($user->photo) : asset('img/logo.png') }}"  alt="Profile" class="rounded-circle" style="width: 120px; height: 120px; object-fit: cover;">
                                    ...
                                    <form id="deleteProfileImageForm" action="{{ route('profil.delete_image') }}" method="POST" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                ...
                                <div class="tab-pane fade pt-3" id="profile-change-password">
                                    ...
                                    <form method="POST" action="{{ route('changementMotDePasse') }}">
                                        @csrf
