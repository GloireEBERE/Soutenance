            ...
            <section class="signup">
                ...
                <div class="container">
                    <div class="signup-content">
                        <form action="<?php echo e(route('demande.update', $demande->id)); ?>" method="POST" id="signup-form" class="signup-form" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <?php if($demande->lettre_de_demande): ?>
                                    <p>Fichier actuel : <a href="<?php echo e(asset($demande->lettre_de_demande)); ?>" target="_blank">Voir la lettre</a></p>
                                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <?php if($demande->cv): ?>
                                    <p>Fichier actuel : <a href="<?php echo e(asset( $demande->cv)); ?>" target="_blank">Voir le CV</a></p>
                                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="date" class="form-control" name="date_soumission" id="date_soumission" value="<?php echo e(old('date_soumission', $demande->date_soumission)); ?>" required>
...
</html><?php /**PATH C:\laragon\www\stagiaire\resources\views/stagiaire/modifierDemande.blade.php ENDPATH**/ ?>