            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">La liste des refus</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->

            <div class="container">
                <h2 class="text-center">La liste des stagiaires refusés</h2>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $stagiaires; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $stagiaire): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    <div class="showPhoto">
                                    <div id="imagePreview" style="<?php if($stagiaire->user->photo != ''): ?> background-image:url('<?php echo e(url('/')); ?>/uploads/<?php echo e($stagiaire->user->photo); ?>')<?php else: ?> background-image: url('<?php echo e(url('/img/logo.png')); ?>') <?php endif; ?>;"></div>
                                    </div>
                                </td>

                                <td><?php echo e($stagiaire->demandes->where('statut', 'refusée')->first()->statut); ?></td>
                            </tr>
...
</html><?php /**PATH C:\laragon\www\stagiaire\resources\views/admin/stagiaireRefuse.blade.php ENDPATH**/ ?>