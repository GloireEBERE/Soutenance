                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview"> 
                                ...
                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                    ...
                                    <!-- Profile Edit Form -->
                                    <form action="<?php echo e(route('profil.TuteurUpdate')); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <form id="deleteProfileImageForm" action="<?php echo e(route('profil.deleteImages')); ?>" method="POST" style="display: none;">
                                        <?php echo csrf_field(); ?>
                                ...
                                <div class="tab-pane fade pt-3" id="profile-change-password">
                                    ...
                                    <form action="<?php echo e(route('changementMotDePasse')); ?>" method="POST">
...
</html><?php /**PATH C:\laragon\www\stagiaire\resources\views/tuteur/profil.blade.php ENDPATH**/ ?>