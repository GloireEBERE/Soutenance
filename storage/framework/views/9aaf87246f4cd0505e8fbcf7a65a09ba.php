        ...
        <main id="main" class="main">
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $taches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tache): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><?php echo e($index + 1); ?> </td>
                                <td><?php echo e($tache->titre_tache); ?></td>
                                <td><?php echo e($tache->description_tache); ?></td>
                                <td><?php echo e(\Carbon\Carbon::parse($tache->date_debut)->format('d/m/Y')); ?></td>
                                <td>
                                    <?php if(isset($tache->id)): ?>
                                        <form action="<?php echo e(route('stagiaireTache.update', ['id' => $tache->id])); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit" name="statut" value="<?php echo e(\App\Models\Tache::STATUT_TERMINEE); ?>" class="btn btn-success" aria-label="Marquer la tâche comme terminée">Terminée</button>
                                            <button type="submit" name="statut" value="<?php echo e(\App\Models\Tache::STATUT_ANNULEE); ?>" class="btn btn-danger" aria-label="Marquer la tâche comme annulée">Annulée</button>
                                        </form>
                                    <?php else: ?>
...
</html><?php /**PATH C:\laragon\www\stagiaire\resources\views/stagiaire/TacheListeFaire.blade.php ENDPATH**/ ?>