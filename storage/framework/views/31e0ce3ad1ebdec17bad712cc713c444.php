            ...
            <?php if(auth()->check()): ?>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
                        <li class="dropdown-header">
                            ...
                            <a href="javascript:void(0)">
                                <span class="badge rounded-pill bg-primary p-2 ms-2">Tout voir</span>
                            </a>
                        </li>
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('profil.tuteur')); ?>">
...
</header><!-- End Header --><?php /**PATH C:\laragon\www\stagiaire\resources\views/layouts/tuteurHeader.blade.php ENDPATH**/ ?>